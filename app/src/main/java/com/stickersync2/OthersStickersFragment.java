...
public class OthersStickersFragment extends Fragment {

    private OthersStickersViewModel viewModel;
    private StickerAdapter adapter;
    private TextView tvCount;
    private Button btnRefresh;

    public OthersStickersFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // Observer les stickers "Autres"
        viewModel = new ViewModelProvider(this).get(OthersStickersViewModel.class);

...
public class FacebookStickersFragment extends Fragment {

    private FacebookStickersViewModel viewModel;
    private StickerAdapter adapter;
    private TextView tvCount;
    private Button btnRefresh;

    public FacebookStickersFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // Observer les stickers Facebook
        viewModel = new ViewModelProvider(this).get(FacebookStickersViewModel.class);

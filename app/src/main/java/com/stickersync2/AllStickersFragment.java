...
public class AllStickersFragment extends Fragment {

    private AllStickersViewModel viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_all_stickers, container, false);
        ...
        // Observer tous les stickers
        viewModel = new ViewModelProvider(this).get(AllStickersViewModel.class);

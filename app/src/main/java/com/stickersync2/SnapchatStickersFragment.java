...
public class SnapchatStickersFragment extends Fragment {

    private SnapchatStickersViewModel viewModel;
    private StickerAdapter adapter;
    private TextView tvCount;
    private Button btnRefresh;

    public SnapchatStickersFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // Observer les stickers Snapchat
        viewModel = new ViewModelProvider(this).get(SnapchatStickersViewModel.class);
